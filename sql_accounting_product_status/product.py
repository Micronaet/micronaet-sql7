                ...
                try:
                    ...
                    if item_id:
                        ...
                        self.write(cr, uid, item_id, {
                            ...
                            'sql_order_customer':
                                record.get('NQT_ORD_CLI', 0.0),
                            'sql_order_customer_suspended':
                                record.get('NQT_SOSP_CLI', 0.0),
                            'sql_order_customer_auto':
                                record.get('NQT_CLI_AUT', 0.0),
                            'sql_order_supplier':
                                record.get('NQT_ORD_FOR', 0.0),
                            'sql_order_production':
                                record.get('NQT_INPR', 0.0),
                            'sql_min_level':
                                record.get('NQT_SCORTA_MIN', 0.0),
                            'sql_max_level':
